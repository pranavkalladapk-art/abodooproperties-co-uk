    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/how", changefreq: "monthly", priority: "0.8" },
          ...
          { path: "/blog/rent-to-serviced-accommodation", changefreq: "monthly", priority: "0.6" },
          { path: "/blog/hmo-vs-serviced-accommodation", changefreq: "monthly", priority: "0.6" },
          { path: "/blog/brrrr-strategy-uk", changefreq: "monthly", priority: "0.6" },
