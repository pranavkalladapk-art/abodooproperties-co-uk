...
export default function AboutSection() {
  ...
  return (
    <section ref={ref} className="py-32" style={{ background: '#0B1426' }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          <div className="font-inter text-[11px] tracking-[0.18em] text-gold mb-4">OUR STORY</div>
          <h2 className="font-playfair text-ivory" style={{ fontSize: 'clamp(32px, 4vw, 52px)' }}>
            Built by investors, for property owners.
          </h2>
          <p className="font-inter text-[17px] leading-relaxed mt-6" style={{ color: 'rgba(248,246,242,0.68)' }}>
          ...
          <p className="font-inter text-[17px] leading-relaxed mt-4" style={{ color: 'rgba(248,246,242,0.68)' }}>
          ...
          <div className="flex flex-wrap gap-2 mt-6 font-inter text-[13px]" style={{ color: 'rgba(248,246,242,0.45)' }}>
          ...
          <a href="#contact" className="inline-block mt-8 border border-gold text-gold px-6 py-2.5 rounded-md font-inter text-[14px] hover:bg-gold hover:text-midnight transition">
            Meet the team →
          </a>
        </div>
